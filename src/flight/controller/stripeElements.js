...
exports.stripeElements=async(req,res)=>{
    ...
    FlightBooking.findById(req.bookingId).exec(async(err,data)=>{
        ...
        const fares = Math.round((data.invoice_fare+(data.seat_charge_total_fare?data.seat_charge_total_fare:0)+(data.seat_assignment_total_fare?data.seat_assignment_total_fare:0))*100)
